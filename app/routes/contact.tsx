            ...
            <div className="p-12 md:p-24 md:pt-32">
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-gothic lg:text-[18px] text-xs">{t("contact.phone")} +82 063 535 8294</span>
                </div>

                <div className="flex items-center gap-4">
                  <img src="/images/icons/phone_icon.png" alt="mobile" width={32} height={32} className="shrink-0" />
                  <span className="font-gothic lg:text-[18px] text-xs">{t("contact.mobile")} +82 010 8411 9944</span>
                </div>

                <div className="flex items-center gap-4">
                  <img src="/images/icons/fax_icon.png" alt="fax" width={32} height={32} className="shrink-0" />
                  <span className="font-gothic lg:text-[18px] text-xs">{t("contact.fax")} +82 0504 333 9944</span>
                </div>
              ...
              <div className="mt-40 relative">
                <div className="relative z-10 flex items-center justify-start gap-4">
                  ...
                  <div className="w-[2px] h-6 bg-brand-blue-light mx-1" />
                  <div className="text-dark-gray text-sm md:text-[18px] font-gothic leading-relaxed pt-1">
